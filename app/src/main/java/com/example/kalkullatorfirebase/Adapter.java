package com.example.kalkullatorfirebase;
...
public class Adapter extends RecyclerView.Adapter<com.example.kalkullatorfirebase.Adapter.MyViewHolder> {
    private Context Ctx;
        ...
        holder.Hapus.setOnClickListener(v ->
                ...
                db.collection("data_hitung").document(prosesHitung.getID())
                        ...
                        .addOnSuccessListener(aVoid -> {
                            Intent intent = new Intent(Ctx, com.example.kalkullatorfirebase.MainActivity.class);
